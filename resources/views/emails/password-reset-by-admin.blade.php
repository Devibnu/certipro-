...
/**
 * ============================================================================
 * CertiPro LSP - Password Reset by Admin Email Template
 * ============================================================================
 * Gmail-compatible | Table-based | Inline CSS | Max 600px
 * Compliance: ISO 27001, ISO 17024, BNSP
 * Variables: $nama, $resetLink, $expiresInMinutes, $adminName
 * ============================================================================
 */
...
<title>Reset Password Akun - {{ $systemName }}</title>
<!--[if mso]>
<style type="text/css">
...
<td style="padding: 35px 40px 30px 40px;">
    ...
    <td align="center" style="padding-bottom: 25px;">
        <span style="font-size: 24px; font-weight: bold; color: #111827; font-family: Arial, Helvetica, sans-serif;">Reset Password Akun Anda</span>
    </td>
    </tr>
    </table>
    ...
    <td style="padding-top: 18px; font-size: 15px; color: #374151; line-height: 24px; font-family: Arial, Helvetica, sans-serif;">
        Administrator sistem (<strong>{{ $adminName }}</strong>) telah mengirimkan permintaan reset password untuk akun Anda. Klik tombol di bawah ini untuk mengatur password baru.
    </td>
    </tr>
    </table>
